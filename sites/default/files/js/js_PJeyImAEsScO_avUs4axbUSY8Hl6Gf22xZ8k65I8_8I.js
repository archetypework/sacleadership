...
$(document).bind('state:required', function(e) {
  if (e.trigger) {
    var formWrapper = $(e.target).closest('.form-item, .form-wrapper');	  
    if (e.value) {
 //     $(e.target).closest('.form-item, .form-wrapper').find('label').append('<span class="form-required">*</span>');
       formWrapper.find('label .form-required').remove();
       formWrapper.find('label').append('<span class="form-required">*</span>');
    }
    else {
      formWrapper.find('label .form-required').remove();		
